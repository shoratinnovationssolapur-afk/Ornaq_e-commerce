...
// Add Eye and EyeOff here
import { Mail, Lock, Phone, ShieldCheck, UserRound, Eye, EyeOff } from "lucide-react";
...
export default function LoginPage({ initialAccountType }) {
  ...
  {/* Eye toggle button */}
  <button
    type="button" // Critical to prevent accidental form submissions
